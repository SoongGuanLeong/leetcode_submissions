<h2><a href="https://leetcode.com/problems/first-letter-capitalization">First Letter Capitalization</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>Table: <code>user_content</code></p>
